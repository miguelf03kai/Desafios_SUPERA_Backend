...
INSERT INTO transferencia (id,data_transferencia, valor, tipo, nome_operador_transacao, conta_id) VALUES (7,'2021-05-07 12:45:04+03',-2547.09,'TRANSFERENCIA', 'Sicrano',1);
INSERT INTO transferencia (id,data_transferencia, valor, tipo, nome_operador_transacao, conta_id) VALUES (8,'2021-06-08 01:25:04+03',251.59,'TRANSFERENCIA', 'Fulano',2);
INSERT INTO transferencia (id,data_transferencia, valor, tipo, nome_operador_transacao, conta_id) VALUES (9,'2021-07-05 10:47:04+03',-251.49,'TRANSFERENCIA', null,1);
